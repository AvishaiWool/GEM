...
#define STRUCT_IPINFO		struct ip6t_ip6
#define STRUCT_TCPINFO		struct ip6t_tcp
#define STRUCT_INADDR		struct in6_addr
...
#define TC_GET_IP_ADDR	get_ip6_addr
...
void get_ip6_addr(STRUCT_INADDR addr1, STRUCT_INADDR addr2, unsigned int *l_item, unsigned int *r_item)
{
	*l_item = 0;
	*r_item = 0;
}
